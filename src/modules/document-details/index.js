...
import { useDetails, useDocumentDetails } from '@/hooks/use-details';
...
export default function DocumentDetailsModule() {
    ...
    const { data = [], refetch, isFetching } = useDocumentDetails({
        index,
        document_id,
        query
    }, () => { })
